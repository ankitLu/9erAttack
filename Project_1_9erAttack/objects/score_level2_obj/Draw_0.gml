...
with(Score_obj) var l2267EDF2_0 = current_score < 30;
if(l2267EDF2_0)
{
	...
	/// @DnDArgument : "caption" ""Achieve a score of 30 to advance!""
	draw_text((cam_x+500), (cam_y+75), string("Achieve a score of 30 to advance!") + "");
}
...
else
{
	...
	draw_text((cam_x+500), (cam_y+75), string("Congratulations! Advance to the right!") + "");
